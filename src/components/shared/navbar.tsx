...
const Navbar = () => {
  ...
  return (
    <nav className="py-4 overflow-hidden fixed top-0 z-50 w-full">
      <div className="container mx-auto flex justify-between items-center">
        <Link href="/">
          ...
          >
            ...
            ></path>{" "}
            <path
              d="M46.9241 8.62749H43.7932V22.7548H52.4605V19.9866H46.9241V8.62749Z"
              className="cneutral"
              fill="#333237"
            ></path>{" "}
            <path
        ...
        <motion.ul
          ...
          className={`fixed md:hidden flex flex-col bg-gray-800 top-16 bottom-0 px-16 py-8 space-y-8 ease-in-out transition-all duration-1000  ${
